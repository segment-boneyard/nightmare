...
class Nightmare {
    ...
    *emulateKeystrokes(selector, text) {
        ...
        return this._invokeRunnerOperation("emulateKeystrokes", { keyCodes: keyCodes });
    }
    ...
    *inject(type, file) {
        ...
        if (type === 'js') {
            ...
            return this._invokeRunnerOperation("javascript", template.inject({ src: js }));
        }
        else if (type === 'css') {
    ...
    *insert(selector, text) {
        ...
        if (!text) {
            ...
            return this._invokeRunnerOperation("insert", text);
        }
    }
    ...
    *type() {
        ...
        if (!text) {
            ...
            return this._invokeRunnerOperation("type", text);
        }
    };
