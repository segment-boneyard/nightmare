...
function Nightmare(options) {
  ...
  this.child.on('did-finish-load', function () { log('did-finish-load'); });
  this.child.on('did-fail-load', function () { log('did-fail-load'); });
  this.child.on('did-frame-finish-load', function () { log('did-frame-finish-load'); });
  this.child.on('did-start-loading', function () { log('did-start-loading'); });
  this.child.on('did-stop-loading', function () { log('did-stop-loading'); });
  this.child.on('did-get-response-details', function () { log('did-get-response-details'); });
  this.child.on('did-get-redirect-request', function () { log('did-get-redirect-request'); });
  this.child.on('dom-ready', function () { log('dom-ready'); });
  this.child.on('page-favicon-updated', function () { log('page-favicon-updated'); });
  this.child.on('new-window', function () { log('new-window'); });
  this.child.on('will-navigate', function () { log('will-navigate'); });
  this.child.on('crashed', function () { log('crashed'); });
  this.child.on('plugin-crashed', function () { log('plugin-crashed'); });
  this.child.on('destroyed', function () { log('destroyed'); });
}
