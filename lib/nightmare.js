...
function Nightmare(options) {
  ...
  this.child.on('page-prompt', function(message, response){
    log('page-prompt', message, response);
  });

  this.child.on('page-confirm', function(message, response){
    log('page-confirm', message, response);
  });
