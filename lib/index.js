...
/**
 * Returns true if the error happend during loading
 * @returns {boolean}
 */
Nightmare.prototype.hasError = function() {
  return this.resourceError ? true : false;
}

/**
 * Returns the error which happened
 * @returns {boolean}
 */
Nightmare.prototype.getError = function() {
  return this.resourceError;
}

/**
 * Returns the response from PhantomJS
 * @returns {boolean}
 */
Nightmare.prototype.getResponce = function() {
  return this.response;
}

/**
 * Returns the status code of the page (404, 200 etc.)
 * @returns {number}
 */
Nightmare.prototype.getStatusCode = function() {
  return this.response ? this.response.status : 0;
}

/**
 * Return true if the status code if 2** family
 * @returns {boolean}
 */
Nightmare.prototype.isSuccessfullStatusCode = function() {
