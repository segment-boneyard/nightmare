...
(function () {
    ...
    console.log = function () {
        __nightmare.ipc.send('console', 'log', __nightmare._.slice(arguments));
    ...
    console.warn = function () {
        __nightmare.ipc.send('console', 'warn', __nightmare._.slice(arguments));
    ...
    console.error = function () {
        __nightmare.ipc.send('console', 'error', __nightmare._.slice(arguments));
