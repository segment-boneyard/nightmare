...
// get the args from runner.
// URL protocols that don't need to be checked for validity
// can add websocket here, to add more reliability?
...
// you want to process arguments?
// how to add multiple args? use template?
var processArgs = JSON.parse(process.argv[process.argv.length-1])
...
if (switches) {
  for (let i in switches) {
    app.commandLine.appendSwitch(i, switches[i])
	  // i mean, is it really running?
//	  console.log("appending",i);
  }
}
// unable to see shit here. spawned.
/**
 * Hide the dock
 */
