...
exports.click = function(selector, done) {
  exports.triggerMouseEvent.call(this, selector, 'click', done);
};

/**
 * Trigger Mouse on events.
 *
 * @param {String} selector
 * @param {String} event
 * @param {Function} done
...
exports.triggerMouseEvent = function(selector, eventName, done) {
  debug('.triggerMouseEvent(' + eventName + ') on ' + selector);
  this.page.evaluate(function(selector, eventName) {
