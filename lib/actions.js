...
exports.goto = function(url, done) {
  ...
  var self = this;
  self.response = null;
  self.resourceError = null;
  var current_url = url;

  this.page.set("onUrlChanged", function(new_url) {
    self.url = new_url;
    current_url = new_url;
  });

  this.page.set("onResourceReceived", function(response) {
    if(response.url == current_url) {
      self.response = response;
    }
  });
  this.page.set("onResourceError", function(resourceError) {
    if(resourceError.url == current_url) {
