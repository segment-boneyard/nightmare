 ...
 * Get the html.
 *
 * @param {String} [selector] Use to find an element, by default will get the whole page content.
 * @param {Boolean} [parent=false] Allows to retrieve the parent HTML contents of the matching element
 * @param {Function} callback
 * @param {Function} done
 */

exports.html = function(selector, parent, callback, done) {
  ...
  debug('.html() getting it on %s %s', selector, parent ? "'s parent" : '');
  this.page.evaluate(function(selector, parent) {
