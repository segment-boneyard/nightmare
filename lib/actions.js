...
/**
 * Set the scroll position to left and top of element by selector.
 *
 * @param {String} selector
 * @param {Function} done
 */

exports.scrollToSelector = function (selector, done) {
  debug('.scrollToSelector()');
  var self = this;
...
/**
 * Take a screenshot of element by selector.
 *
 * @param {String} path
 * @param {String} selector
 * @param {Function} done
...
exports.screenshotSelector = function (path, selector, done) {
