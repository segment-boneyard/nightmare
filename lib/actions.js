...
exports.visible = function(selector, callback, done) {
  ...
  this.page.evaluate(function(selector) {
    ...
    style, isSizeGreaterThanZero, isElementDisplayed, isElementVisible, isElementOpaque;
    if (!elem) {
      return false;
    }
    ...
    return isSizeGreaterThanZero && isElementDisplayed && isElementVisible && isElementOpaque;
  }, function(result) {
    callback(result);
    done();
  }, selector);
