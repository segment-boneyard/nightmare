...
/**
 * Take a screenshot, rendered to a Base64 string.
 *
 * @param {String} format
 * @param {Function} done
 */

exports.screenshotBase64 = function(format, done) {
  debug('.screenshotBase64() saved to ' + format + ' buffer');
  this.page.renderBase64(format, done);
};
