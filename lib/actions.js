...
exports.navigateToSelector = function (navigationObj, done) {
  for (var i = 0; i < navigationObj.length; i++) {
    module.exports[navigationObj[i].event](navigationObj[i].selector)
  }
};
