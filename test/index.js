/* global describe, before, after, beforeEach, afterEach, window, document, it, alert, $, ipc */
...
describe('Nightmare', function () {
  ...
  describe('navigation', function () {
    ...
    it('should not time out for aborted loads', function (done) {
      Nightmare.action(
        'abortRequests',
        function (name, options, parent, win, renderer, done) {
          win.webContents.session.webRequest.onBeforeRequest(
  ...
  describe('evaluation', function () {
    ...
    describe('asynchronous', function () {
      ...
      it('should allow for timeouts in asynchronous evaluation with a callback', function * () {
        ...
        yield nightmare
          .goto(fixture('evaluation'))
          .evaluate(function (done) { // eslint-disable-line no-unused-vars
            // don't call done
          }).should.be.rejected;
      });
  ...
  describe('rendering', function () {
    ...
    for (var i = 0; i < 3; i++) {
      it('should screenshot an up-to-date image of the page (' + i + ')', function * () {
        ...
        var pixel = firstPixel[1];
        pixel.should.be.above(100);
      });
    }
  ...
  describe('options', function () {
    ...
    it('should fail on authentication failure', function * () {
      nightmare = Nightmare();
      var data = yield nightmare // eslint-disable-line no-unused-vars
