/* global it, describe, before, after, beforeEach, afterEach, document, window */
...
describe('Nightmare', function () {
  ...
  it('should have version information', function * () {
    const nightmare = Nightmare();
    const versions = yield nightmare.engineVersions();
  ...
  describe('navigation', function () {
    ...
    it('should return data about the response', function * () {
      const data = yield nightmare.goto(fixture('navigation'));
    ...
    it('should wait until the evaluate fn with arguments returns true', function * () {
      yield nightmare
        ...
        .wait(function (expectedA, expectedB) {
          const textA = document.querySelector('a.a').textContent;
          const textB = document.querySelector('a.b').textContent;
    ...
    it('should return correct data when child frames are present', function * () {
      const data = yield nightmare.goto(fixture('navigation/valid-frame'));
